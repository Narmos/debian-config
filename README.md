...
> **Remarque :** par défaut, le script installe Flatpak. Pour désactiver Flatpak, modifier la variable `FLATPAK=true` en `FLATPAK=false` dans le fichier `config-debian.sh`
